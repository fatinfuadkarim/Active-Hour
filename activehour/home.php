      ...
      <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="img/books.jpg" class="d-block w-100 h-100" alt="First slide">
            <div class="carousel-caption d-none d-md-block">
              <h1 style="color: black; font-size: 50px;"></h1>
              <h2 style="color: black;">Read a Book</h2>
            </div>
          </div>
          <div class="carousel-item">
           <img src="img/music.jpg" class="d-block w-100 h-100" alt="Second slide"> 
            <div class="carousel-caption d-none d-md-block">
              <h2 style="color: skyblue;">Listen to Music or podcasts</h2>
            </div>
          </div>
          <div class="carousel-item">
           <img src="img/phone.jpg" class="d-block w-100 h-100" alt="Third slide">
            <div class="carousel-caption d-none d-md-block">
              <h2 style="color: black; font-size: 28px;">Call someone</h2>
            ...
            <form class="signup-form" action="signup_inc.php" method="post">
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="email" class="form-control" name="email" id="inputEmail4"  name=placeholder="Email">
                </div>
                <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input name="uID" type="text" class="form-control"  id="uID" placeholder="User ID">
                </div>
    ...
    <footer>
      <div class="wrapper">
        ...
        <div class="footer-bottom">
          <ul>
            <li><a style="color: skyblue;">© Copyright ActiceHour 2019-2020. All Rights Reserved.</a></li>
